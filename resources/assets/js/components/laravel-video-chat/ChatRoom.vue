            ...
            <div class="col-md-6">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <span class="glyphicon glyphicon-comment"></span> Chat with {{ withUser.first_name }}
...
<script>
    ...
    $(function () {
        ...
        let answerButton = document.getElementById('answerCallButton');
        answerButton ? answerButton.onclick = answerCall : '';
    ...
    function onAnswer(){
        var remoteOffer = JSON.parse(localStorage.getItem('offer'))
        remoteOffer.sdp = remoteOffer.sdp += '\n';
